...
if __name__ == '__main__':
    goal = [0, 0]
    with open('/home/alperenlcr/Code/ros_workspaces/maze_ws/src/main/scripts/size.txt', 'r') as f:
        size = int(f.read())
        goal[0] = size - 1
        goal[1] = size - 0.5
    ...
    turtlebot_robot1_goal.target_pose.pose.position.x = goal[0]
    turtlebot_robot1_goal.target_pose.pose.position.y = goal[1]
